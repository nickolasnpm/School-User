...
{
    public class GetClassSubjectTeacherListByTeacherIdHandler : IRequestHandler<GetClassSubjectTeacherListByClassSubjectIdQuery, IEnumerable<ClassSubjectTeacher>?>
    {
        private readonly IClassSubjectTeacherRepository _classSubjectTeacherRepository;

        public GetClassSubjectTeacherListByTeacherIdHandler(IClassSubjectTeacherRepository classSubjectTeacherRepository)
        {
        ...
        {
            return await _classSubjectTeacherRepository.GetListByTeacherIdAsync(request.classSubjectId);
        }
    }
}